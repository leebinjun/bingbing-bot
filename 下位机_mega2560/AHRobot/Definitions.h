...
int robotPixX;//机器人坐标（像素）
int robotPixY;//机器人坐标（像素）
int robotCoordX;//机器人坐标（mm）
int robotCoordY;//机器人坐标（mm）
int robotCoordSamples=0;//累加变量，累加10次进行一次处理
int robotCoordXAverage=0;//机器人10次x轴坐标平均值（mm）
int robotCoordYAverage=0;//机器人10次y轴坐标平均值（mm）
int robotMissingStepsErrorX;//机器人缺失的位移（mm）
int robotMissingStepsErrorY;//机器人缺失的位移（mm）
long attack_time;
int attack_pos_x;
int attack_pos_y;
